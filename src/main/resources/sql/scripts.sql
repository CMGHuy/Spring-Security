...
INSERT IGNORE INTO `users` VALUE (NULL, 'happy', '12345', '1');
INSERT IGNORE INTO `authorities` VALUE (NULL, 'happy', 'write');
...
INSERT INTO `customer` (`email`, `pwd`, `role`) VALUES ('caominhgiahuy@gmail.com', '54321', 'admin');
